...
xdmffile_disp = XDMFFile('cant_aluminum_deflection.xdmf')
xdmffile_stress = XDMFFile('cant_aluminum_stress.xdmf')
xdmffile_vonmises = XDMFFile('cant_alumninum_vonMises.xdmf')
